...
function pdt360DegViewer(id, n, p, t, playable, autoPlay, draggable, mouseMove, buttons, keys, scroll) {
   ...
   var img = document.querySelector(`#${id} .${id}`).parentElement;
   ...
   if (!playable && !autoPlay) {
      ...
      function touchFun() {
         ...
         img.addEventListener('touchmove', function (e) {
            logic(this.querySelector("img"), e);
            // logic(this.querySelectorAll("img")[1], e);
         });
      ...
      function nonTouch() {
         ...
         function mouseEvent() {
            img.addEventListener('mousemove', function (e) {
               (drag) ? logic(this.querySelector("img"), e) : null;
               // (drag) ? logic(this.querySelectorAll("img")[1], e) : null;
            });
